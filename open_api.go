...
func OpenAPI2Rules(openAPIConfigs map[string]*OpenAPIConfig) DomainsMap {
	res := make(DomainsMap)
...
func MergeRules(existing DomainsMap, new DomainsMap) DomainsMap {
	if existing == nil {
		existing = make(DomainsMap)
	}
